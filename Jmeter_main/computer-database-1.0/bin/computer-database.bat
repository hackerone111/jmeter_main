@REM computer-database launcher script
@REM
@REM Envioronment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM COMPUTER_DATABASE_config.txt found in the COMPUTER_DATABASE_HOME.
@setlocal enabledelayedexpansion

@echo off
if "%COMPUTER_DATABASE_HOME%"=="" set "COMPUTER_DATABASE_HOME=%~dp0\\.."
set ERROR_CODE=0

set "APP_LIB_DIR=%COMPUTER_DATABASE_HOME%\lib\"
...
set "CFG_FILE=%COMPUTER_DATABASE_HOME%\COMPUTER_DATABASE_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running computer-database.
  echo.
